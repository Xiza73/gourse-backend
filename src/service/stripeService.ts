...
export class StripeService {
    ...
    constructor() {
        ...
        this.stripe = new Stripe('sk_test_51Lr9lSIYCYVqXiULGRee2aGxiPE5d4qbN2LCILSdl1KocWiMNCx52XlkNsX8idutrewIbM0yNPWZJ4lUnUEQqS6b00kL13LbJV', {
    ...
    */
    ...
    public generatePaymentIntent = async ({ user, payment_method }: {user: any, payment_method: any}) => {
